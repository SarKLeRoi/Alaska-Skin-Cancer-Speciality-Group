...
function skinCancer() {
  ...
  return (
    <>
      <Head>
        <title>Skin Cancer - Alaska Skin Cancer Specialty Group</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content="Comprehensive information about skin cancer types and conditions treated by the Alaska Skin Cancer Specialty Group - basal cell carcinoma, squamous cell carcinoma, melanoma, and atypical lesions."
        />
        <meta
          property="og:title"
          content="Skin Cancer - Alaska Skin Cancer Specialty Group"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.alaskaskincancer.com/skinCancer"
        />
        ...
        <meta
          name="keywords"
          content="skin cancer Alaska, basal cell carcinoma, squamous cell carcinoma, melanoma, atypical lesions, skin cancer treatment Alaska"
        />
        <meta name="author" content="Alaska Skin Cancer Specialty Group"></meta>
        <link rel="icon" href="/images/favicon.png" />
        <link rel="canonical" href={`${baseUrl}/skinCancer`} />
      </Head>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Comprehensive information about skin cancer types and conditions treated by the Alaska Skin Cancer Specialty Group - basal cell carcinoma, squamous cell carcinoma, melanoma, and atypical lesions.",
            address: {
              "@type": "PostalAddress",
              addressCountry: "US",
        ...
        <main>
          ...
          <section className="hero-section" aria-labelledby="hero-heading">
            ...
            >
              <img
                ...
                alt="Comprehensive skin cancer care - expert diagnosis and treatment for all skin cancer types"
              />
          ...
          >
            <TextCentered
              newPadding={"5px"}
              title={"Skin Cancer"}
              description={`Our team specializes in the diagnosis and treatment of all types of skin cancer. From the most common basal cell carcinomas to complex melanomas, we provide expert care using the latest techniques and technologies.

Explore the sections below to learn more about specific skin cancer types, their characteristics, and how our collaborative approach ensures the best possible outcomes for our patients.`}
            />
          </motion.section>
          ...
          >
            ...
            >
              <div className="container">
                ...
                <Link href="/skinCancer/melanoma" className="menu-item">
                  Melanoma
                </Link>
                <Link href="/skinCancer/atypicalLesions" className="menu-item">
                  Atypical Lesions
                </Link>
              </div>
            </motion.div>
